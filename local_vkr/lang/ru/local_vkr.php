...
$string['instructionurl'] = 'Ссылка на инструкцию';
$string['instructionurl_desc'] = 'URL инструкции, ссылка на которую отображается вверху вкладки «Главная» модуля ВКР. Оставьте пустым, чтобы скрыть ссылку.';
