...
/**
 * Form for assigning reviewers to students.
 *
 * @package     mod_vkr
 * @copyright   2025 Ifraim Solomonov <solomonov@sfedu.ru>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reviewer_form extends moodleform {
    /**
     * Form definition.
     *
     * @return void
    ...
    protected function definition(): void {
        ...
        $reviewers = $customdata['reviewers'] ?? [];
        ...
        $mform->addElement('hidden', 'tab', 'reviewer');
        $mform->setType('tab', PARAM_ALPHA);
        $mform->addElement('hidden', 'savereviewers', 1);
        $mform->setType('savereviewers', PARAM_INT);
        ...
        foreach ($reviewers as $reviewer) {
            ...
            $mform->setDefault($fieldname, $currentmapping[(int)$reviewer->id] ?? []);
        }
