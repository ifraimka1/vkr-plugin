...
$string['noassessor'] = 'Нет оценщика';
$string['selectgroup'] = 'Выберите группу';
$string['selectassessor'] = 'Выберите оценщика';
$string['apply'] = 'Применить';
$string['notification_assessorassigned'] = 'Оценщик успешно назначен.';
$string['notification_assessorerror'] = 'Ошибка при назначении оценщика.';
$string['normcontrol_role'] = 'Нормоконтроль';
